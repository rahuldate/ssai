...
def render_bayesian_module():
    ...
    with col1:
        ...
        smiles_bayes = st.text_input("Target SMILES for Bayesian Profiling", value="CC(=O)OC1=CC=CC=C1C(=O)O", key="bayes_smiles_2026")
        ...
        # Odds form of Bayes theorem: Posterior Odds = Prior Odds * LR1 * LR2 * LR3
    ...
    with col2:
        ...
        # Plot prior vs posterior probability bar chart
