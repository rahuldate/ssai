...
def create_regulatory_pdf_dossier(filename="Skin_Sensitization_Dossier.pdf", compound_name="Cinnamaldehyde", smiles="O=CC=Cc1ccccc1", prediction="SENSITIZER (Category 1)", lumo_val="-1.42 eV", omega_val="0.73", verdict="REACTIVE ELECTROPHILE"):
    ...
    # Quantum-Chemical & Thermodynamic Profile
    ...
    doc.build(story)
    print(f"Successfully generated updated quantum dossier: {filename}")
